<div>
    <?php
    $gradeItems = App\Models\Manage\Grade::whereIn('id',\App\Models\Manage\Lesson::all()->pluck('id_grade'))->pluck('name', 'id');
    $subjectItems = App\Models\Manage\Subject::whereIn('id',\App\Models\Manage\Lesson::all()->pluck('id_subject'))->pluck('name', 'id');
    $chapterItems = App\Models\Manage\Chapter::whereIn('id',\App\Models\Manage\Lesson::all()->pluck('id_chapter'))->pluck('name', 'id');
    ?>
