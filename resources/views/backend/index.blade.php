...
$products = User::where(DB::raw("(DATE_FORMAT(created_at,'%Y'))"), Carbon\Carbon::now()->year)->get();
$resultest = ResultTest::where(DB::raw("(DATE_FORMAT(created_at,'%Y'))"), Carbon\Carbon::now()->year)->get();
